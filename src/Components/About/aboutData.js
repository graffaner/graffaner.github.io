...
const aboutData = {
    aboutme:[
        "Hey, welcome to my web! I'm currently working as a Data Engineer at a small fintech start up called Micah! Our company provides a web platform for bank lenders to interface with their customers. Although my job title is formally data engineer, I have mostly been working on backend features. I learned that I really enjoy working in the backend and will most likely tailor my career more towards software than data.",
        "Aside from my full-time position, I am also a part-time computer science Masters student at Georgia Tech with a specialization in machine learning. I'm expecting to graduate in Spring 2024; after 3 long years. While I have my reservations about academics and the pursuit for higher education, I got to meet a lot of really cool people and gain fundamental knowledge in a field I pivoted to.",
        'Due to my minimal experience in the software industry, I have been fortunate to supplement my experience with a part-time contract job at a non-profit. While I do have a lot on my plate, I am very conscious to not be "over-employed". I commit around 5 to 10hrs/week outside of work hours. IPSDI is a non-profit that "procures, assembles, analyzes, and reports information from fire, rescue, and law enforcement data."',
        "In my personal time, I love to play games like Valorant and Apex Legends. Gaming helps exercise my decision-making and awareness. As a poor example, I refer to my rear-view mirror as my mini-map and try to be aware of all the cars around me. When it's time to make a lane change, I know I can be confident my blind-spot is clear. In the winter season, I am an avid snowboarder. I'm an Epic pass season holder and have been to Whistler, Breckinrige, Keystone, Vail, Beaver Creek, Palisades, Kirkwood, North Star, Heavenly, Steven's Pass, Mammoth Mountain, and June Mountain. I also love to play tennis and go bowling when I get the chance. And finally after all that, if I have time, I am passionate about my personal projects and Medium blogs! Check out my active & previous projects out in the projects tab."
    ],
    why_meche:[
